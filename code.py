# -*- coding: utf-8 -*-
"""RAGImplementaion.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/15wTIUgy2Umx38UCOZiBELO32D7ocXCg5
"""
...
loader = TextLoader("/content/python.text",encoding="utf-8")
...
all_pdf_documents = load_pdf_from_path("/content/Research.pdf")
...
all_pdf_chunks = text_splitter.split_documents(all_pdf_documents)

print(f"Created {len(all_pdf_chunks)} chunks from the PDF document.")
...
vector_store.add_documents(all_pdf_chunks, emebedding)
...
llm = ChatOpenAI(
    ...
    model_name="gpt-5.4",
    temperature = 0.1 ,     #tell model how much to be creative
    max_tokens = 1024
)
...
def generate_output(query, retriever, llm, top_k=3):
    ...
    response = llm.invoke(prompt) # expecting a string as prompt , ask q give ans
